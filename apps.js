...
const canciones = [
    {
        titulo: 'I See Red',
        nombre: 'Canelita',
        fuente: 'Gianel/I See Red.mp3',
        fondo: 'Gianel/I See Red.jpg'
    },
    {
        titulo: 'Morado',
        nombre: 'Canelita',
        fuente: 'Gianel/Morado.mp3',
        fondo: 'Gianel/Morado.jpg'
        
    },
    {
    titulo: 'Siesta Freestyle',
    nombre: 'Canelita',
    fuente: 'Gianel/Siesta Freestyle (mp3cut.net).mp3',
    fondo: 'Gianel/Siesta Freestyle (mp3cut.net).mp3'
    }
];
